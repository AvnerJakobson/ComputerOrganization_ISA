a1_loop:
	add $s2, $s2, $imm2, $zero, 0, 1 						# col_counter++
	add $s0, $s0, $imm2, $zero, 0, 1 						# increment res_mat_pointer by 1
	add $a1, $a1, $imm2, $zero, 0, 1						# increment a1 by 1
	jal $ra, $zero, $zero, $imm2, 0, mult_mat_elems			# get result
...
inner_loop:
	...
	jal $ra, $zero, $zero, $imm2, 0, mult_mat_elems 		# get one result
	sw $v0, $s0, $zero, $zero, 0, 0 						# set res_mat[elem] to v0
	add $s1, $zero, $imm2, $zero, 0, 1						# set $s1 = row_counter = 1
	add $s2, $zero, $imm2, $zero, 0, 1						# set $s2 = col_counter = 1